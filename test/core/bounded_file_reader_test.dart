...
void main() {
  ...
  setUp(() async {
    directory = await Directory.systemTemp.createTemp('notenest-bounded-reader-');
  });
  ...
  test('reads a native file when every observed length is within the limit', () async {
  ...
  test('rejects a file whose reported size exceeds the configured limit', () async {
